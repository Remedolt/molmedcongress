...
var I18N = {
  ...
  // wrapped in lang="en" so CSS text-transform:uppercase doesn't apply
  // Turkish dotted-İ casing rules to this English name when <html lang="tr">
  // (that's what turned "Turkish" into "TURKİSH" on screen)
